  ...
  DocumentReference postRef = FirebaseFirestore.instance.collection("User Posts").doc(postId);
  ...
  await postRef.update({
    ...
    void navigateToPostDetail(String postId, String postMessage, String postUser, List<dynamic> comments) {
    Navigator.push(
      context,
      MaterialPageRoute(
        ...
        onComment: (commentText) => addComment(postId, commentText), // Callback to add comment
        ),
      ),
    );
  }
                        ...
                        child: ListView.builder(
                          ...
                          itemBuilder: (context, index) {
                            ...
                            return WallPost(
                              ...
                              likedBy: likedBy,
                              onLike: () => onLikePost(postId),
                              onComment: (commentText) => navigateToPostDetail(postId, message, userEmail, data['Comments'] ?? []),
                            );
                          },
                        ),
                      );
